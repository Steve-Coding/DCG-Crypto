// Copyright (c) 2017-2018 The DailyCrypto developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef DailyCrypto_ZDCGWALLET_H
#define DailyCrypto_ZDCGWALLET_H
...
public:
    CzDCGWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZDCG(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZDCG(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //DailyCrypto_ZDCGWALLET_H

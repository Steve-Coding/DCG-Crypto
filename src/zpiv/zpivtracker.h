...
#ifndef DailyCrypto_ZDCGTRACKER_H
#define DailyCrypto_ZDCGTRACKER_H
...
public:
    CzDCGTracker(std::string strWalletFile);
    ~CzDCGTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzDCGWallet* zDCGWallet = NULL);
...
#endif //DailyCrypto_ZDCGTRACKER_H

...
#include "qt/dailycrypto/forms/ui_navmenuwidget.h"
...
NavMenuWidget::NavMenuWidget(DailyCryptoGUI *mainWindow, QWidget *parent) :
    ...
    ui(new Ui::NavMenuWidget)
{
    ...
    setCssProperty(ui->imgLogo, "img-nav-logo-dailycrypto");

...
#include "qt/dailycrypto/forms/ui_topbar.h"
#include <QPixmap>
...
TopBar::TopBar(DailyCryptoGUI* _mainWindow, QWidget *parent) :
...
void TopBar::loadWalletModel(){
    ...
    // update the display unit, to not use the default ("DailyCrypto")
    updateDisplayUnit();

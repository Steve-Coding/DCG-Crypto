...
#include "qt/dailycrypto/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/dailycrypto/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(DailyCryptoGUI* _window, QWidget *parent) :

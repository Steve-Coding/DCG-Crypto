...
#include "qt/dailycrypto/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/dailycrypto/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(DailyCryptoGUI* _window, QWidget *parent) :

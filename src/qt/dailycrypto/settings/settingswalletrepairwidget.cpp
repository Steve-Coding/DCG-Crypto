...
#include "qt/dailycrypto/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/dailycrypto/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(DailyCryptoGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to DailyCryptoGUI::handleRestart()

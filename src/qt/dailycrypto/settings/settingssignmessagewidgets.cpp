...
#include "qt/dailycrypto/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(DailyCryptoGUI* _window, QWidget *parent) :

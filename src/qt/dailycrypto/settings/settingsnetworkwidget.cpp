...
#include "qt/dailycrypto/settings/settingsnetworkwidget.h"
#include "qt/dailycrypto/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/dailycrypto/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(DailyCryptoGUI* _window, QWidget *parent) :

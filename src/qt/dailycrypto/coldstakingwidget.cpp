...
#include "qt/dailycrypto/forms/ui_coldstakingwidget.h"
#include "qt/dailycrypto/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/dailycrypto/requestdialog.h"
...
#include "qt/dailycrypto/csrow.h"
...
ColdStakingWidget::ColdStakingWidget(DailyCryptoGUI* parent) :
    PWidget(parent),
    ...
    isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your DCGs, letting a hot node (24/7 online node)\nstake on your behalf, while you keep the keys securely offline."));
    ...
    ui->labelSubtitle2->setText(tr("Accept DCG delegation / Delegate DCG"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select DCG outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 DCG" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}

...
#include "qt/dailycrypto/coincontrolpivwidget.h"
#include "qt/dailycrypto/forms/ui_coincontrolpivwidget.h"
    ...
    ui(new Ui::CoinControlPivWidget)
{
    ...
    ui->labelTitle->setText("Select DCG Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("DCG");
    ...
    ui->labelValueAfter->setText("0.00 DCG");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 DCG");
    ui->labelValueFee->setText("0.00 DCG");

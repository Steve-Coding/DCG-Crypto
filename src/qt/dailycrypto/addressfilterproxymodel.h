...
#ifndef DailyCrypto_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define DailyCrypto_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //DailyCrypto_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H

...
#include <QWidget>
#include <QString>
#include "qt/dailycrypto/prunnable.h"
...
class PWidget : public QWidget, public Runnable, public Translator
{
    Q_OBJECT
public:
    explicit PWidget(DailyCryptoGUI* _window = nullptr, QWidget *parent = nullptr);
    explicit PWidget(PWidget *parent = nullptr);

    void setClientModel(ClientModel* model);
    void setWalletModel(WalletModel* model);

    DailyCryptoGUI* getWindow() { return this->window; }

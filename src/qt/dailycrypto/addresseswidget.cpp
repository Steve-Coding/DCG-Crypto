...
#include "qt/dailycrypto/forms/ui_addresseswidget.h"
#include "qt/dailycrypto/addresslabelrow.h"
#include "qt/dailycrypto/addnewaddressdialog.h"
...
AddressesWidget::AddressesWidget(DailyCryptoGUI* parent) :
    PWidget(parent),
    ui(new Ui::AddressesWidget)
{
    ...
    // Address
    ui->labelAddress->setText(tr("Enter DailyCrypto address"));

...
/** Utility functions used by the DailyCrypto Qt UI.
 */
namespace GUIUtil
{
...
// Render DailyCrypto addresses in monospace font
...
// Parse "dailycrypto:" URI into recipient object, return true on successful parsing

...
bool Intro::pickDataDirectory()
{
	...
	intro.fillMnemonicSeed();
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Daily Crypto Giveaways"),
     ...
     * override -datadir in the dailycrypto.conf file in the default data directory
     * (to be consistent with dailycryptod behavior)
     */

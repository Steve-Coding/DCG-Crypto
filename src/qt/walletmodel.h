...
#ifndef DailyCrypto_QT_WALLETMODEL_H
#define DailyCrypto_QT_WALLETMODEL_H
...
/** Interface to DailyCrypto wallet from Qt view code. */
...
#endif // DailyCrypto_QT_WALLETMODEL_H

 ...
 * DailyCrypto system. There are three: the main network on which people trade goods
...
public:
    ...
    int DailyCryptoBadBlockTime() const { return nDailyCryptoBadBlockTime; }
    int DailyCryptoBadBlocknBits() const { return nDailyCryptoBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nDailyCryptoBadBlockTime;
    unsigned int nDailyCryptoBadBlocknBits;

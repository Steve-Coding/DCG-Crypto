...
public:
    ...
    bool WriteZDCGSeed(const uint256& hashSeed, const std::vector<unsigned char>& seed);
    bool ReadZDCGSeed(const uint256& hashSeed, std::vector<unsigned char>& seed);
    bool ReadZDCGSeed_deprecated(uint256& seed);
    bool EraseZDCGSeed();
    bool EraseZDCGSeed_deprecated();

    bool WriteZDCGCount(const uint32_t& nCount);
    bool ReadZDCGCount(uint32_t& nCount);

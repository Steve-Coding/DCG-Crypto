...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw std::runtime_error(
            ...
            "  \"balance\": xxxxxxx,           (numeric) the total dailycrypto balance of the wallet\n" // (excluding zerocoins)\n"
...
/*
            "  \"zDCGsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zDCG denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zDCG denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zDCG denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zDCG denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zDCG denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zDCG denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zDCG denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zDCG denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zDCG denominations\n"
            "  }\n"
*/
            "  \"keypoololdest\": xxxxxx,      (numeric) the timestamp (seconds since GMT epoch) of the oldest pre-generated key in the key pool\n"
            "  \"keypoolsize\": xxxx,          (numeric) how many new keys are pre-generated\n"
            "  \"unlocked_until\": ttt,        (numeric) the timestamp in seconds since epoch (midnight Jan 1 1970 GMT) that the wallet is unlocked for transfers, or 0 if the wallet is locked\n"
            "  \"paytxfee\": x.xxxx,           (numeric) the transaction fee set in dailycrypto/kb\n"
            "  \"relayfee\": x.xxxx,           (numeric) minimum relay fee for non-free transactions in dailycrypto/kb\n"
...
/*
    ...
    obj.push_back(Pair("zDCGsupply", zpivObj));
*/
#ifdef ENABLE_WALLET
    if (pwalletMain) {
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw std::runtime_error(
            "validateaddress \"dailycryptoaddress\"\n"
            "\nReturn information about the given dailycrypto address.\n"

            "\nArguments:\n"
            "1. \"dailycryptoaddress\"     (string, required) The dailycrypto address to validate\n"

            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"dailycryptoaddress\",    (string) The dailycrypto address validated\n"
            "  \"scriptPubKey\" : \"hex\",       (string) The hex encoded scriptPubKey generated by the address\n"
            "  \"ismine\" : true|false,          (boolean) If the address is yours or not\n"
            "  \"isstaking\" : true|false,       (boolean) If the address is a staking address for DailyCrypto cold staking\n"
...
#ifdef ENABLE_WALLET
        // Case 1: DailyCrypto address and we have full public key:
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
        throw std::runtime_error(
            ...
            "2. \"keys\"       (string, required) A json array of keys which are dailycrypto addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) dailycrypto address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw std::runtime_error(
            "verifymessage \"dailycryptoaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"

            "\nArguments:\n"
            "1. \"dailycryptoaddress\"  (string, required) The dailycrypto address to use for the signature.\n"
...
UniValue getstakingstatus(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw std::runtime_error(
            ...
            "  \"staking_enabled\": true|false,    (boolean) if staking is enabled/disabled in dailycrypto.conf\n"

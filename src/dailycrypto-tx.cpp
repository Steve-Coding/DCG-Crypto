...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Daily Crypto Giveaways dailycrypto-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  dailycrypto-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dailycrypto transaction") + "\n" +
                               "  dailycrypto-tx [options] -create [commands]   " + _("Create hex-encoded dailycrypto transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded dailycrypto transaction

...
The script [extract-osx-sdk.sh](https://github.com/dailycrypto-project/dailycrypto/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
dailycrypto/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/dailycrypto-project/dailycrypto/blob/master/doc/README_osx.md) for troubleshooting tips.
Contributing to Daily Crypto Giveaways
============================

The Daily Crypto Giveaways project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/dailycrypto-project/dailycrypto/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Daily Crypto Giveaways project, and is not to be
confused with overall DailyCrypto Network Protocol consensus changes.

Whether a pull request is merged into Daily Crypto Giveaways rests with the project merge
...
Patches that change DailyCrypto consensus rules are considerably more involved than
...
Where a patchset proposes to change the DailyCrypto consensus, it must have been
...
The project leader is the release manager for each Daily Crypto Giveaways release.

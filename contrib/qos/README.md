...
This means one can have an always-on dailycryptod instance running, and another local dailycryptod/dailycrypto-qt instance which connects to this node and receives blocks from it.

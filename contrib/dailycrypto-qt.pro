...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/dailycrypto-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/dailycrypto-cli.cpp \
           src/dailycrypto-tx.cpp \
           src/dailycrypto.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/dailycrypto.qrc src/qt/dailycrypto_locale.qrc

TRANSLATIONS += src/qt/locale/dailycrypto_bg.ts \
                src/qt/locale/dailycrypto_de.ts \
                src/qt/locale/dailycrypto_en.ts \
                src/qt/locale/dailycrypto_es.ts \
                src/qt/locale/dailycrypto_fi.ts \
                src/qt/locale/dailycrypto_fr.ts \
                src/qt/locale/dailycrypto_it.ts \
                src/qt/locale/dailycrypto_ja.ts \
                src/qt/locale/dailycrypto_pl.ts \
                src/qt/locale/dailycrypto_pt.ts \
                src/qt/locale/dailycrypto_ru.ts \
                src/qt/locale/dailycrypto_sk.ts \
                src/qt/locale/dailycrypto_sv.ts \
                src/qt/locale/dailycrypto_vi.ts \
                src/qt/locale/dailycrypto_zh_CN.ts \
                src/qt/locale/dailycrypto_zh_TW.ts

...
class RawTransactionsTest(DailyCryptoTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid dailycrypto address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid dailycrypto address" in e.error['message'])

...
from test_framework.dailycrypto_node import DailyCryptoTestNode
...
class DailyCrypto_ColdStakingTest(DailyCryptoTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(DailyCryptoTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, None, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 DCG from the pot)
...
if __name__ == '__main__':
    DailyCrypto_ColdStakingTest().main()
